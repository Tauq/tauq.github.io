$(document).ready(function(){
	...
	$(".menuButton").click(function(){
		event.preventDefault();
			...
			$(".sectionTitle").css("position","static");    // Setting this to static rather than relative makes the menu appear correctly, otherwise it gets cut off at the bottom
	...
	$(".menuAtTopCloseAnchor").click(function(){
		event.preventDefault();
			...
			$(".sectionTitle").css("position","relative");  // Setting this to static rather than relative makes the menu appear correctly, otherwise it gets cut off at the bottom
	});
